...
- (void)drawRect:(CGRect)rect
{
	...
	for (int i = 0; i < _rating; i++)
	{
		...
		else
        {
            ...
            NSDictionary *attributes = @{NSFontAttributeName: [UIFont boldSystemFontOfSize:_starFontSize]};
            [kDefaultSolidChar drawAtPoint:currPoint withAttributes:attributes];
...
//            [kDefaultSolidChar drawAtPoint:currPoint withFont:[UIFont boldSystemFontOfSize:_starFontSize]];
	...
	for (int i = 0; i < remaining; i++)
	{
		...
		else
        {
            ...
            NSDictionary *attributes = @{NSFontAttributeName: [UIFont boldSystemFontOfSize:_starFontSize]};
            [kDefaultEmptyChar drawAtPoint:currPoint withAttributes:attributes];
